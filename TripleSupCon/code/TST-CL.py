...
from TripleTSTCL_loss_Type3 import CELoss, SupConLoss
...
class Instructor:
    ...
    def _train(self, dataloader, criterion, optimizer):
        ...
        return train_loss / n_train, n_correct / n_train,loss_init
    ...
    def run(self):
        ...
        for fold, (train_indices, val_indices) in enumerate(kf.split(dataset)):
            ...
            train_dataloader = torch.utils.data.DataLoader(train_sampler, batch_size=self.args.train_batch_size,
                                                           num_workers=workers, collate_fn=collate_fn, pin_memory=True,
                                                           shuffle=False)
            test_dataloader = torch.utils.data.DataLoader(val_sampler, batch_size=self.args.test_batch_size,
                                                          num_workers=workers, collate_fn=collate_fn, pin_memory=True,
                                                          shuffle=False)
