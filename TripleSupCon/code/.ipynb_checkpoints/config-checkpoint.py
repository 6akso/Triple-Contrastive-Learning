...
def get_config():
    ...
    num_classes = {'sst2': 2, 'subj': 2, 'trec': 6, 'pc': 2, 'cr': 2,'agnews':4,'sougounews':5,'dbpe':14,'arix':10,'sst5':5}
    ''' Base '''
    parser.add_argument('--data_dir', type=str, default='data')
    parser.add_argument('--dataset', type=str, default='agnews', choices=num_classes.keys())
    ...
    parser.add_argument('--save_path', type=str, default=r'C:\Users\18496\Desktop\luan\triplet\duallearning\Dual-Contrastive-Learning')
    ''' Optimization '''
